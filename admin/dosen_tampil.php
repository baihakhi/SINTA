...
<html>
    ...
    <script src="../js/ajax.js"></script>
      ...
      <button class="btn btn-default" onClick="window.location.href='dosen_add.php'">Tambah Dosen</button>
...
//        echo $akses;
              ...
              if ($akses == "Administrator") {
                ?>
                  <td>
                    <a href="dosen_edit.php?nip=<?= $nip ?>">edit</a>
                    <div data-id=<?= $nip ?> style="display:inline">
                      <button onClick="$(this).HapusDosen()">hapus</button>
                    </div>
