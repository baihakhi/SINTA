<?php
	...
	if(!isset($_POST['edit'])){
		...
		if ($validNip && $validNama && $validPass && $validUsername) {
			...
			$query = "UPDATE eksekutif SET nip='".$nip."', nama='".$nama."', password='".$password."', username='".$username."' WHERE nip='".$niplawas."'";
						...
						<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
							...
							<div class="form-body form-body-info">
								...
								<span class="label label-success"><?php if(isset($pesan_sukses)) echo $pesan_sukses;?></span><br>
									...
									<div class="form-group">
										<input type="text" name="nip" id="nip" required="true" class="form-control" value="<?php if(isset($nip)){echo $nip;} ?>">
									</div>
									...
									<div class="form-group">
										<input type="text" name="username" id="username" required="true" data-minlength="6" class="form-control" placeholder="Username" value="<?php if(isset($username)){echo $username;} ?>">
